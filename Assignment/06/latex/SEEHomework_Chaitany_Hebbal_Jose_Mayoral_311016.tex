...
The last proofs that the error on the measurement fit on a $2\sigma$ Gaussian Distribution. This means that a $68.2\%$ of values will lie between the range $\left[-\sigma,+\sigma\right]$.
